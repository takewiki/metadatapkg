  ...
  model = model_getFromJson(json_file = 'data-raw/sales/saleOrder_save_cp.json')

  #step 2:create the entity table into dbms.
  # t_api_kdc_entity
   model_entity_read(file_name = 'data-raw/kdc_entityTable.xlsx')
  #step3: create the data
   mydata = model_dataAllPart(json_file = 'data-raw/sales/saleOrder_save_cp.json',FOwnerName = 'CP',FFormName = '销售订单',FActionDesc = '保存')





mydata = model$FSaleOrderEntry[[1]]

names(mydata[['FAuxPropId']])
